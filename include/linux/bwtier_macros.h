...
#define LLC_MISS_LOADS_COUNTER \
		PERF_COUNT_HW_CACHE_LL | \
		PERF_COUNT_HW_CACHE_OP_READ << 8 | \
		PERF_COUNT_HW_CACHE_RESULT_MISS << 16
#define LLC_MISS_STORES_COUNTER \
		PERF_COUNT_HW_CACHE_LL | \
		PERF_COUNT_HW_CACHE_OP_WRITE << 8 | \
		PERF_COUNT_HW_CACHE_RESULT_MISS << 16
#define NUM_BWTIER_COUNTERS 2

#define SAMPLE_BATCH_SIZE 1000
#define BWTIER_NR_CPUS 96
#define MAX_PAGES_PER_CPUEVENT 1024	// must be power of 2

#define NUM_BWTIER_BINS 16
#define SYS_RECORDS_HIST_LEN 8
...
#define KSAMPLD_PERIOD_MS 40	// must be a factor of 1000

/* ERRORS */
#define ERR_BWTIER_INVAL_BININDEX 101
#define ERR_BWTIER_RANGE 102
#define ERR_BWTIER_INVAL_NID 103
#define ERR_BWTIER_NO_FOLIO 104
#define ERR_BWTIER_FOLIO_LOCK 105
